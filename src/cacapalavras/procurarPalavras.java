...
public class procurarPalavras {
    ...
    private static int tamanhoDoVetor = formarSopaDeLetras.numeroPalavras;
    private static int tamanhoDoVetorDoPosicoesDasLetra = 0;
    private static int contador = 0;
    public static String isEqual = "", coordenadasSaida = "";
    ...
    public static void verificaNoCacaPalavra(String[] listaPalavras) {
        ...
        for (int i = 0; i < palavrasChaves.length; i++) {
            ...
            if (linhaDoElementoQueConsta != -1 && colunaDoElementoQueConsta != -1) {
                coordenadasSaida = coordenadasSaida + " " + (1 + linhaDoElementoQueConsta) + " " + (1 + colunaDoElementoQueConsta) + "\n";
            }
